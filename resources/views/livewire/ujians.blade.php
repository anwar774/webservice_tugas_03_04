                    ...
                    @forelse($ujians as $row)
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <button wire:click="delete({{ $row->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 show_confirm rounded" onclick="confirm('Confirm delete?') || event.stopImmediatePropagation()">Hapus</button>
